...
if(!isset($_GET['catid']) || $_GET['catid']==NULL ){
	echo "<script>window.location ='404.php'</script>";
	 ...
	 if(isset($_GET['loc']) && $id){
		$loc = $_GET['loc'];
		$loc_product_frontend = $product->getproduct_cate_list_loc($loc,$id);
	 }
				...
				<?php
					...
					<?php
						if(isset($loc_product_frontend)){
							$productbycat = $loc_product_frontend;
						}
						else{
							...
							<div class="product-item style1 width-33 col-md-4 col-sm-6 col-xs-6">
								<div class="product-inner">
									...
									<div class="product-innfo">
										<div class="product-name"><a href="details.php?proid=<?php echo $value['productId'] ?>">
